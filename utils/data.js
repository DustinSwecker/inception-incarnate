...
const thoughtData = [
    {
        ...
        username: `seriouslythough`,
        reactions: [
            reactionData[0], reactionData[1], reactionData[2]
        ]
    ...
    },
    {
        ...
        username: `dude`,
        reactions: [
            reactionData[2], reactionData[3], reactionData[4]
        ]
    ...
    },
    {
        ...
        username: `user3`,
        reactions: [
            reactionData[5], reactionData[6], reactionData[7]
        ]
    ...
    },
    {
        ...
        username: `whyme`,
        reactions: [
            reactionData[8], reactionData[9], reactionData[9]
        ]
        ...
        username: `user1`,
        reactions: [
            reactionData[1], reactionData[4], reactionData[7]
        ]
        ...
        username: `whatwhat`,
        reactions: [
            reactionData[2], reactionData[5], reactionData[8]
        ]
        ...
        username: `snappyresponsegenerator`,
        reactions: [
            reactionData[3], reactionData[4], reactionData[9]
        ]
        ...
        username: `yoyogirl420`,
        reactions: [
            reactionData[1], reactionData[8], reactionData[9]
        ]
        ...
        username: `user2`,
        reactions: [
            reactionData[2], reactionData[5], reactionData[7]
        ]
        ...
        username: `derelictdeejay`,
        reactions: [
            reactionData[0], reactionData[3], reactionData[6]
        ]
